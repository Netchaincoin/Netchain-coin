...
static const uint256 hashGenesisBlock("0x0a1231d62bcc914c868604acd09e61ae832d2bc00fd56a29b30fad80b7be33a0");
...
public:
    ...
    {
        // netchain: the coin stake transaction is marked with the first output empty
    ...
    */
     ...
     */
    bool FetchInputs(CTxDB& txdb, const std::map<uint256, CTxIndex>& mapTestPool, //srdnlfrt
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // netchain: get transaction coin age
...
public:
    ...
    // netchain: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // netchain: two types of block: proof-of-work or proof-of-stake
    ...
    // netchain: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // netchain: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // netchain: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // netchain: block index flags
    enum
    {
