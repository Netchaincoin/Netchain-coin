...
// netchain: total coins staked (non-spendable until maturity)
...
// netchain: check 'spent' consistency between wallet and txindex
// netchain: fix wallet spent state according to txindex
...
// netchain: disable transaction (only for coinstake)
